...
ALTER TABLE `tasks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `task_status_idx` (`status_id`),
  ADD KEY `task_engineer_idx` (`engineer_id`);
...
--
ALTER TABLE `tasks`
  ADD CONSTRAINT `task_engineer_fk` FOREIGN KEY (`engineer_id`) REFERENCES `engineers` (`id`),
  ADD CONSTRAINT `task_status_fk` FOREIGN KEY (`status_id`) REFERENCES `statuses` (`id`);
COMMIT;
